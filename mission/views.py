...
listRando = [
	...
	["Cour des Chutes de la Biche" ,"Plaines d'Ashford, Point de passage de la Cité d'Ascalon (je suis partie du point de passage de la Forêt de Cadem, ce qui n'est pas le plus court).",
	...
	["Fontaine des racines cachées" ,"Le Bosquet, Point de passage du spéculateur, Niveau intermédiaire/inférieur. Entrez dans le tunnel.",
	...
	["Grenier effondré" ,"Marais de la Lumillule, Point de passage de la Maison de Frimo (Fort Cadence est très souvent contesté).",
	...
	["Recoin lapidaire de Flakk" ,"Rata Sum, Syndicat de la dynamique, Point de passage de la comptabilité, niveau intermédiaire/inférieur.",
	...
	["Sépulcre ravagé" ,"Plateau de Diessa, Point de passage Landes ravagées. Plongez dans l'eau, sur votre gauche, un tunnel puis un trou dans un mur, continuez tout droit en tuant les mobs au passage. Sur la gauche un passage en forme de porte et un escalier de pierres.",
